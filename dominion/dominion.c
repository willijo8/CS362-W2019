...
void cutpurseCard(int currentPlayer, int handPos, struct gameState *state){
    int i;
    int j;
    int k;
...
int treasure_mapCard(int currentPlayer, int handPos, struct gameState *state){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case cutpurse:
        cutpurseCard(currentPlayer, handPos, state);
        return 0;
    ...
    case treasure_map:
        return treasure_mapCard(currentPlayer, handPos, state);
    }
